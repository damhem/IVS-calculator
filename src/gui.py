...
# Date: 2021-03-22
# File includes gui for calculator

##
#   @file gui.py
#
#   @brief Contains the Ui_Dialog class(for help popup),Calculator_ui class(for calculator gui)
#   @author Daniel Čechák, xcecha06
#
...
##
# @brief Class Ui_Dialog contains initialization for help popup
#
...
##
# @brief Class Calculator_ui contains initialization for Calculator gui
#
class Calculator_ui(object):
	...
	# @brief Function for opening help popup
	#
	# @param self The object pointer.
	...
	# @brief Function for changing content of items
	#
	# @param self The object pointer.
	# @param Dialog The app window.
    def retranslateUi(self, Dialog):
